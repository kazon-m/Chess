...
namespace Game.Chessmen
{
    public class BoardManager : MonoBehaviour
    {
        ...
        private AbstractChess SelectedChessMan;
        ...
        public AbstractChess[,] ChessMans { set; get; }
        ...
        private void SpawnChessMan(int index, int x, int y)
        {
            ...
            ChessMans[x, y] = chessGO.GetComponent<AbstractChess>();
            ChessMans[x, y].Position.x = x;
            ChessMans[x, y].Position.y = y;
        ...
        private void SpawnAllChessMan()
        {
            ...
            ChessMans = new AbstractChess[8, 8];
